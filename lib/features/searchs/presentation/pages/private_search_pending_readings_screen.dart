...
class PrivateSearchPendingReadingsScreen extends StatelessWidget {
  const PrivateSearchPendingReadingsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => sl<PendingReadingsCubit>()),
      ],
      child: const _PrivateSearchPendingReadingsView(),
    );
  }
}

class _PrivateSearchPendingReadingsView extends StatefulWidget {
  const _PrivateSearchPendingReadingsView();

  @override
  State<_PrivateSearchPendingReadingsView> createState() =>
      _PrivateSearchPendingReadingsViewState();
}

class _PrivateSearchPendingReadingsViewState
    extends State<_PrivateSearchPendingReadingsView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (loginState is LoginSuccess) {
        context.read<PendingReadingsCubit>().searchPendingReadings(
          '201501027211', // TODO: Reemplazar por el clientId real si es necesario.
        );
      }
    });
  }
  ...
  void _onSearch() {
    ...
    context.read<PendingReadingsCubit>().searchPendingReadings('201501027211');
  }
          ...
          SafeArea(
            child: Column(
              children: [
                ...
                // _buildSearchInput is removed for private search
      ...
      builder: (context, state) {
        if (state is PendingReadingsInitial) {
          return _buildEmptyState(
            ...
            'Se está consultando su información',
          );
